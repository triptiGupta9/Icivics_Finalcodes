...
public class GoogleSignOn extends ProjectSpecificMethods {
	...
	public GoogleSignOn(RemoteWebDriver driver, ExtentTest node, Properties prop, String Environment, String StageURL, String Stage1URL) {
		this.driver = driver;
		this.node = node;
		this.prop = prop;
	...
	public GoogleSignOn verifydeleteuserfrombackend2() {
	...
	public  GoogleSignOn  verifydeleteuserfrombackend() {
		WebElement signinbutton = propElement(getPropfile(gpropname1, "Signinbutton"));
		signinbutton.click();
		waitTime(3000);
		WebElement signinlink = propElement(getPropfile(gpropname1, "Signinlink"));
