...
public class HomePage_1Header extends ProjectSpecificMethods {
	public String gpropname1 = "Homepage/homepageheader";
	public String gpropname2 = "Homepage/homepageteacherheader";

	public HomePage_1Header(RemoteWebDriver driver, ExtentTest node, Properties prop, String Environment, String StageURL, String Stage1URL) {
		this.driver = driver;
		this.node = node;
		this.prop = prop;
	...
	public HomePage_1Header launchURL() {
	...
	public HomePage_1Header verifyhomepage() {
			verifyUrl(URL);
			reportStep("URL Verified successfully", "Pass");
		return this;
	}

	public HomePage_1Header signin() {
	...
	public HomePage_1Header VerifyLogo() {
	...
	public HomePage_1Header VerifyDonatebutton() {
	...
	public HomePage_1Header Verifyshopbutton() {
	...
	public HomePage_1Header Verifymyicivicsbuttondisplayafterlogin() {
	...
	public HomePage_1Header Verifyheaderbuttonsafterlogin() {
		WebElement donatebutton = propElement(getPropfile(gpropname1, "Donatebutton"));
		if (donatebutton.isDisplayed()) {
	...
	public HomePage_1Header Verifydonationpopup() {
