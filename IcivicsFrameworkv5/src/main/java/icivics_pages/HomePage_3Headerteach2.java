...
public class HomePage_3Headerteach2 extends ProjectSpecificMethods {
	...
	public HomePage_3Headerteach2(RemoteWebDriver driver, ExtentTest node, Properties prop, String Environment, String StageURL, String Stage1URL) {
		this.driver = driver;
		this.node = node;
		this.prop = prop;
	...
	public HomePage_3Headerteach2 launchURL() {
	...
	public HomePage_3Headerteach2 verifyteachmenu() {
	...
	public HomePage_3Headerteach2 verifytextisunderlined() {
		waitTime(3000);
	...
	public HomePage_3Headerteach2 verifytextisunderlined1() {
	...
	public HomePage_3Headerteach2 verifytextisunderlined2() {
	...
	public HomePage_3Headerteach2 verifytextisunderlined3() {
	...
	public HomePage_3Headerteach2 verifytextisunderlined4() {
	...
	public HomePage_3Headerteach2 verifytextisunderlined5() {
		waitTime(3000);
	...
	public HomePage_3Headerteach2 clickteachbuttonagain() {
		WebElement teachbutton = propElement(getPropfile(gpropname1, "Teachbutton"));
		if (teachbutton.isDisplayed()) {
			click(propElement(getPropfile(gpropname1, "Teachbutton")));
