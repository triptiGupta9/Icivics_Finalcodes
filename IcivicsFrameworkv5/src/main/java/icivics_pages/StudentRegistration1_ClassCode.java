...
public class StudentRegistration1_ClassCode extends ProjectSpecificMethods {
	...
	public StudentRegistration1_ClassCode(RemoteWebDriver driver, ExtentTest node, Properties prop, String Environment, String StageURL, String Stage1URL) {
		this.driver = driver;
		this.node = node;
		this.prop = prop;
	...
	public StudentRegistration1_ClassCode launchstudentURL() {
	...
	public StudentRegistration1_ClassCode Clickonwaitihaveaclasscodelink() {
	...
	public StudentRegistration1_ClassCode clickOptionallink() {
	...
	public StudentRegistration1_ClassCode verifyOptionallink() {
		scrollToTheGivenWebElement(getPropfile(gpropname2, "Link"));
		WebElement link = propElement(getPropfile(gpropname2, "Link"));
		link.click();
	...
	public StudentRegistration1_ClassCode hoveronemailfield() throws InterruptedException, IOException {
		WebElement link = propElement(getPropfile(gpropname2, "Link"));
		link.click();
	...
	public StudentRegistration1_ClassCode hoveronverifyemailfield() throws InterruptedException, IOException {
	...
	public StudentRegistration1_ClassCode clickonremovelink() {
		WebElement link = propElement(getPropfile(gpropname2, "Link"));
		link.click();
		scrollToTheGivenWebElement(getPropfile(gpropname2, "Emailaddresslabel"));
		waitTime(5000);
	...
	public StudentRegistration1_ClassCode usernamepregenerated() {
	...
	public StudentRegistration1_ClassCode usernamegeneratedrandomly() throws InterruptedException, IOException {
	...
	public StudentRegistration1_ClassCode entertextinusernamefield() throws InterruptedException, IOException {
	...
	public StudentRegistration1_ClassCode entertextinclasscodefield() throws InterruptedException, IOException {
	...
	public StudentRegistration1_ClassCode entertextinfirstnamefield() throws InterruptedException, IOException {
	...
	public StudentRegistration1_ClassCode entertextinlastnamefield() throws InterruptedException, IOException {
	...
	public StudentRegistration1_ClassCode entertextinemailfield() throws InterruptedException, IOException {
	...
	public StudentRegistration1_ClassCode entertextinverifyemailfield() throws InterruptedException, IOException {
	...
	public StudentRegistration1_ClassCode clicknext() throws InterruptedException, IOException {
	...
	public StudentRegistration1_ClassCode usernameAsteriks() throws IOException {
	...
	public StudentRegistration1_ClassCode classcodeAsteriks() throws IOException {
	...
	public StudentRegistration1_ClassCode firstnameAsteriks() throws IOException {
	...
	public StudentRegistration1_ClassCode lastnameAsteriks() throws IOException {
	...
	public StudentRegistration1_ClassCode emailAsteriks() throws IOException {
		scrollToTheGivenWebElement(getPropfile(gpropname2, "Emailaddresslabel"));
	...
	public StudentRegistration1_ClassCode verifyemailAsteriks() throws IOException {
	...
	public StudentRegistration1_ClassCode verifyinvaliderrormsg() throws InterruptedException {
		WebElement link = propElement(getPropfile(gpropname2, "Link"));
		link.click();
		WebElement classcode = propElement(getPropfile(gpropname2, "classcode"));
		classcode.clear();
	...
	public StudentRegistration1_ClassCode verifyerrormsgblankfieldall() throws InterruptedException {
	...
	public StudentRegistration1_ClassCode verifyerrormsgclasscodeblankfield() throws InterruptedException {
		WebElement classcode = propElement(getPropfile(gpropname2, "classcode"));
		classcode.clear();
	...
	public StudentRegistration1_ClassCode verifyerrormsgfirstnameblankfield() throws InterruptedException {
	...
	public StudentRegistration1_ClassCode verifyerrormsglastnameblankfield() throws InterruptedException {
	...
	public StudentRegistration1_ClassCode verifyerrormsgemailblankfield() throws InterruptedException {
	...
	public StudentRegistration1_ClassCode verifyerrormsgverifyemailblankfield() throws InterruptedException {
	...
	public StudentRegistration1_ClassCode verifyinvaliderrormsg2() throws InterruptedException {
		WebElement link = propElement(getPropfile(gpropname2, "Link"));
		link.click();
		WebElement classcode = propElement(getPropfile(gpropname2, "classcode"));
		classcode.clear();
	...
	public StudentRegistration1_ClassCode verifyregistrationwithvalidvalue() throws InterruptedException, IOException {
		waitTime(5000);
