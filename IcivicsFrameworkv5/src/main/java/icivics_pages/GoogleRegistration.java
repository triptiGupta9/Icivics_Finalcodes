...
public class GoogleRegistration extends ProjectSpecificMethods {
	...
	public GoogleRegistration(RemoteWebDriver driver, ExtentTest node, Properties prop, String Environment, String StageURL, String Stage1URL) {
		this.driver = driver;
		this.node = node;
		this.prop = prop;
	...
	public GoogleRegistration verifydeleteuserfrombackend() {
