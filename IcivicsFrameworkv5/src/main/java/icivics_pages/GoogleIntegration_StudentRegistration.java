...
public class GoogleIntegration_StudentRegistration extends ProjectSpecificMethods {
	...
	public GoogleIntegration_StudentRegistration launchURL() {
	...
	public GoogleIntegration_StudentRegistration verifyregisterasstudent() {
	...
	public GoogleIntegration_StudentRegistration verifyagreetotermsfield() {
	...
	public GoogleIntegration_StudentRegistration verifyerrormsg() {
	...
	public GoogleIntegration_StudentRegistration verifysubmit() throws IOException {
		WebElement agreetoterrms = propElement(getPropfile(gpropname6, "Agreetoterms"));
		if (agreetoterrms.isDisplayed()) {
			agreetoterrms.click();
	...
	public GoogleIntegration_StudentRegistration verifydeleteuserfrombackend() {
