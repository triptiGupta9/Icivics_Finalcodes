...
public class HP_1TeacherHeader extends ProjectSpecificMethods {
	public String gpropname1 = "Homepage/homepageheader";
	public String gpropname2 = "Homepage/homepageteacherheader";

	public HP_1TeacherHeader(RemoteWebDriver driver, ExtentTest node, Properties prop, String Environment, String StageURL, String Stage1URL) {
		this.driver = driver;
		this.node = node;
		this.prop = prop;
	...
	public HP_1TeacherHeader signin2() {
	...
	public HP_1TeacherHeader VerifyLogo() {
	...
	public HP_1TeacherHeader playbutton() {
	...
	public HP_1TeacherHeader Teachbutton() {
	...
	public HP_1TeacherHeader aboutbutton() {
	...
	public HP_1TeacherHeader donatebutton() {
	...
	public HP_1TeacherHeader shopbutton() {
	...
	public HP_1TeacherHeader verifysigninbutton() {
	...
	public HP_1TeacherHeader Verifymyicivicsbuttondisplayafterlogin() {
	...
	public HP_1TeacherHeader Verifyheaderbuttonsafterlogin() {
		WebElement playbutton = propElement(getPropfile(gpropname2, "Playbutton"));
		if (playbutton.isDisplayed()) {
			reportStep("playbutton is display", "Pass");
		} else {
	...
	public HP_1TeacherHeader verifyblogcontenttype() {
	...
	public HP_1TeacherHeader verifycurriculumcontenttype() {
		scrollToTheGivenWebElement(getPropfile(gpropname2, "Blog"));
	...
	public HP_1TeacherHeader verifydbquestcontenttype() {
		scrollToTheGivenWebElement(getPropfile(gpropname2, "Blog"));
		waitTime(3000);
		WebElement curriculumchkbox = propElement(getPropfile(gpropname2, "Curriculumunit"));
		curriculumchkbox.click();
	...
	public HP_1TeacherHeader verifygamecontenttype() {
		scrollToTheGivenWebElement(getPropfile(gpropname2, "Blog"));
		waitTime(3000);
		WebElement curriculumchkbox = propElement(getPropfile(gpropname2, "Curriculumunit"));
		curriculumchkbox.click();
	...
	public HP_1TeacherHeader verifylessonplaycontenttype() {
		scrollToTheGivenWebElement(getPropfile(gpropname2, "Blog"));
	...
	public HP_1TeacherHeader verifyprofessionaldeveopmentcontenttype() {
		scrollToTheGivenWebElement(getPropfile(gpropname2, "Blog"));
	...
	public HP_1TeacherHeader verifyvideocontenttype() {
		scrollToTheGivenWebElement(getPropfile(gpropname2, "Blog"));
	...
	public HP_1TeacherHeader verifyWebquestcontenttype() {
		scrollToTheGivenWebElement(getPropfile(gpropname2, "Blog"));
	...
	public HP_1TeacherHeader verifyplaybuttonhover() {
	...
	public HP_1TeacherHeader verifyteachbuttonhover() {
	...
	public HP_1TeacherHeader verifyaboutbuttonhover() {
	...
	public HP_1TeacherHeader verifydonatebuttonhover() {
	...
	public HP_1TeacherHeader verifyshopbuttonhover() {
	...
	public HP_1TeacherHeader verifysigninbuttonhover() {
	...
	public HP_1TeacherHeader verifymyicvicsbuttonhoverafterlogin() {
	...
	public HP_1TeacherHeader verifymyicvicsbuttonhover() {
		String myicivicsbuttonhover = getPropfile(gpropname2, "Myicivicsbutton2");
		mouseOverAction(myicivicsbuttonhover);
		waitTime(3000);
		WebElement myicivicstooltip = propElement(myicivicsbuttonhover);
	...
	public HP_1TeacherHeader verifyshopbuttonhover2() {
	...
	public HP_1TeacherHeader resizeheader() {
	...
	public HP_1TeacherHeader carddisplayinlistpattern() {
		Dimension d = new Dimension(768, 1024);
		// Resize the current window to the given dimension
		driver.manage().window().setSize(d);
