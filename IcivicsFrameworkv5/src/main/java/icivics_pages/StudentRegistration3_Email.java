...
public class StudentRegistration3_Email extends ProjectSpecificMethods {
	...
	public StudentRegistration3_Email(RemoteWebDriver driver, ExtentTest node, Properties prop, String Environment, String StageURL, String Stage1URL) {
		this.driver = driver;
		this.node = node;
		this.prop = prop;
	...
	public StudentRegistration3_Email launchstudentURL() {
	...
	public StudentRegistration3_Email verifywithvaliddata() throws IOException {
	...
	public StudentRegistration3_Email verifypagecount3() throws IOException {
	...
	public StudentRegistration3_Email verifycheckmsgdisplay() throws IOException {
	...
	public StudentRegistration3_Email verifyemailheaderlabel() {
	...
	public StudentRegistration3_Email verifyregisteredemaildisplay() throws IOException {
	...
	public StudentRegistration3_Email verifyresendbutton() {
	...
	public StudentRegistration3_Email verifyconfirmationemail() {
		scrollToTheGivenWebElement(getPropfile(gpropname5, "resendbutton"));
		WebElement resendbutton = propElement(getPropfile(gpropname5, "resendbutton"));
		resendbutton.click();
		waitTime(3000);
