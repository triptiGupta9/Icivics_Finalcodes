...
public class HomePage_5HeaderMyicivicsMisc extends ProjectSpecificMethods {
	...
	public HomePage_5HeaderMyicivicsMisc(RemoteWebDriver driver, ExtentTest node, Properties prop, String Environment, String StageURL, String Stage1URL) {
		this.driver = driver;
		this.node = node;
		this.prop = prop;
	...
	public HomePage_5HeaderMyicivicsMisc launchURL() {
	...
	public HomePage_5HeaderMyicivicsMisc verifylogin() {
	...
	public HomePage_5HeaderMyicivicsMisc VerifyDonatebutton() {
	...
	public HomePage_5HeaderMyicivicsMisc VerifyDonateclick() throws IOException {
		waitTime(3000);
	...
	public HomePage_5HeaderMyicivicsMisc VerifyShopbutton() {
	...
	public HomePage_5HeaderMyicivicsMisc VerifyShopbuttonclick() throws IOException {
	...
	public HomePage_5HeaderMyicivicsMisc verifymyicvicsbuttonafterlogin() {
	...
	public HomePage_5HeaderMyicivicsMisc verifywithavatar() {
	...
	public HomePage_5HeaderMyicivicsMisc verifywithnoavatar() {
	...
	public HomePage_5HeaderMyicivicsMisc verifymyicvicsbuttonsubmenu() {
	...
	public HomePage_5HeaderMyicivicsMisc verifymyicivicssubmenulist() {
		WebElement myicivicsbutton = propElement(getPropfile(gpropname2, "Myicivicsbutton"));
		if (myicivicsbutton.isDisplayed()) {
			myicivicsbutton.click();
	...
	public HomePage_5HeaderMyicivicsMisc Myicivicsbuttonelementsverification() throws IOException {
	...
	public HomePage_5HeaderMyicivicsMisc verifyselectedmyicivicsunderlined() {
	...
	public HomePage_5HeaderMyicivicsMisc verifyselectedmyclassesunderlined() {
	...
	public HomePage_5HeaderMyicivicsMisc verifyselectedmyfavoritesunderlined() {
	...
	public HomePage_5HeaderMyicivicsMisc Clickonmyicivicsbuttonagain() {
