...
public class StudentRegistration2Email extends ProjectSpecificMethods {
	...
	public StudentRegistration2Email(RemoteWebDriver driver, ExtentTest node, Properties prop, String Environment, String StageURL, String Stage1URL) {
		this.driver = driver;
		this.node = node;
		this.prop = prop;
	...
	public StudentRegistration2Email launchstudentURL() {
	...
	public StudentRegistration2Email verifypagecount2() throws IOException {
	...
	public StudentRegistration2Email verifywithvaliddata() throws IOException {
	...
	public StudentRegistration2Email clickbackbutton() throws InterruptedException, IOException {
	...
	public StudentRegistration2Email verifyclickingbackbutton() throws InterruptedException, IOException {
	...
	public StudentRegistration2Email verifyusernameisnotremembered() throws IOException {
	...
	public StudentRegistration2Email verifyfirstnameremembered() throws IOException {
	...
	public StudentRegistration2Email verifylastnameremembered() {
	...
	public StudentRegistration2Email verifyemailremembered() {
	...
	public StudentRegistration2Email verifyemailfieldremembered() {
		scrollToTheGivenWebElement(getPropfile(gpropname1, "Emailaddresslabel"));
	...
	public StudentRegistration2Email clickontermsofuselink() throws IOException {
		waitTime(5000);
	...
	public StudentRegistration2Email clickprivacypolicy() {
	...
	public StudentRegistration2Email verifypage2noemailsubscriptioncheckbox() {
	...
	public StudentRegistration2Email hoveronpwdfield() throws InterruptedException {
	...
	public StudentRegistration2Email VerifyPasswordstrengthmeter() {
	...
	public StudentRegistration2Email VerifyPasswordindicatormatch() {
	...
	public StudentRegistration2Email verifyblankerrormsgforpwdandcpwd() {
		scrollToTheGivenWebElement(getPropfile(gpropname3, "finishbutton"));
	...
	public StudentRegistration2Email verifyenterinvaliddataerror() {
	...
	public StudentRegistration2Email verifytermsofuseandprivacycheckbox() {
	...
	@Given("Click on next without entering any valid data and verify the error messages.")
	public StudentRegistration2Email verifyblankerrormsg() {
		scrollToTheGivenWebElement(getPropfile(gpropname3, "finishbutton"));
		String pwd = "gfgh^d$fthf&";
		WebElement password = propElement(getPropfile(gpropname3, "password1"));
		click(propElement(getPropfile(gpropname3, "finishbutton")));
	...
	public StudentRegistration2Email verifypage3loaded() throws InterruptedException, IOException {
