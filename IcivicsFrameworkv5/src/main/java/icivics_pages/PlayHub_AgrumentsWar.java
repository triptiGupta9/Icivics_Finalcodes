...
public class PlayHub_AgrumentsWar extends ProjectSpecificMethods {
	...
	public PlayHub_AgrumentsWar(RemoteWebDriver driver, ExtentTest node, Properties prop, String Environment,
	...
	public PlayHub_AgrumentsWar launchURL() {
	...
	public PlayHub_AgrumentsWar verifylink() {
	...
	public PlayHub_AgrumentsWar verifylinkpopup() {
		WebElement leaderboardachievementlink = propElement(getPropfile(gpropname3, "Leaderboard&Achievementlink"));
	...
	public PlayHub_AgrumentsWar verifydownloadteacherresourcesandassignbuttons() {
	...
	public PlayHub_AgrumentsWar verifydownloadteacherresourcesandassignbuttonsforstudent() {
		WebElement signinbutton = propElement(getPropfile(gpropname3, "Signin"));
		signinbutton.click();
		WebElement signinlink = propElement(getPropfile(gpropname3, "Signinlink"));
		signinlink.click();
	...
	public PlayHub_AgrumentsWar verifydownloadteacherresourcesandassignbuttonsforanonymoususer() {
		scrollToTheGivenWebElement(getPropfile(gpropname3, "scrollelement"));
	...
	public PlayHub_AgrumentsWar verifydownloadteacherresourcesandassignclick() {
		WebElement signinbutton = propElement(getPropfile(gpropname3, "Signin"));
		signinbutton.click();
		WebElement signinlink = propElement(getPropfile(gpropname3, "Signinlink"));
		signinlink.click();
	...
	public PlayHub_AgrumentsWar verifyassignpopup() {
	...
	public PlayHub_AgrumentsWar verifyassignform() {
		String url = "/user/login";
		if (Environment.equals("Stage.d9")) {
			navigateto(StageURL + url);
		} else {
	...
	public PlayHub_AgrumentsWar verifyappleapp() throws IOException {
		String url = "/games";
		String URL;
		{
			if (Environment.equals("Stage.d9")) {
	...
	public PlayHub_AgrumentsWar verifyappleapppage() throws IOException {
		String url = "/games";
		String URL;
		{
			if (Environment.equals("Stage.d9")) {
	...
	public PlayHub_AgrumentsWar verifygoogleplaybutton() throws IOException {
		String url = "/games";
		String URL;
		{
			if (Environment.equals("Stage.d9")) {
	...
	public PlayHub_AgrumentsWar verifygoogleplaypage() throws IOException {
		String url = "/games";
		String URL;
		{
			if (Environment.equals("Stage.d9")) {
	...
	public PlayHub_AgrumentsWar verifyextensionpacklink() {
		WebElement signinbutton = propElement(getPropfile(gpropname3, "Signin"));
		signinbutton.click();
		WebElement signinlink = propElement(getPropfile(gpropname3, "Signinlink"));
		signinlink.click();
	...
	public PlayHub_AgrumentsWar verifyextensionpacklinkforsortifygame() {
		WebElement signinbutton = propElement(getPropfile(gpropname3, "Signin"));
		signinbutton.click();
		WebElement signinlink = propElement(getPropfile(gpropname3, "Signinlink"));
		signinlink.click();
	...
	public PlayHub_AgrumentsWar verifyextensionpacklinkforanonymoususer() {
		scrollToTheGivenWebElement(getPropfile(gpropname3, "caseinclude"));
		waitTime(3000);
	...
	public PlayHub_AgrumentsWar verifyextensionpacklinkforastudent() {
		WebElement signinbutton = propElement(getPropfile(gpropname3, "Signin"));
		signinbutton.click();
		WebElement signinlink = propElement(getPropfile(gpropname3, "Signinlink"));
		signinlink.click();
	...
	public PlayHub_AgrumentsWar verifyextensionpacklinkclick() {
		WebElement signinbutton = propElement(getPropfile(gpropname3, "Signin"));
		signinbutton.click();
		WebElement signinlink = propElement(getPropfile(gpropname3, "Signinlink"));
		signinlink.click();
	...
	public PlayHub_AgrumentsWar verifylearningobjectivessection() {
		WebElement signinbutton = propElement(getPropfile(gpropname3, "Signin"));
		signinbutton.click();
		WebElement signinlink = propElement(getPropfile(gpropname3, "Signinlink"));
		signinlink.click();
	...
	public PlayHub_AgrumentsWar verifylearningobjectivessectionasananonymoususer() {
	...
	public PlayHub_AgrumentsWar verifylearningobjectivessectionasstudent() {
		WebElement signinbutton = propElement(getPropfile(gpropname3, "Signin"));
		signinbutton.click();
		WebElement signinlink = propElement(getPropfile(gpropname3, "Signinlink"));
		signinlink.click();
