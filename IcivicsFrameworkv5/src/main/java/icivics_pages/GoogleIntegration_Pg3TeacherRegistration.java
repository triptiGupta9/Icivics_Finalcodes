...
public class GoogleIntegration_Pg3TeacherRegistration extends ProjectSpecificMethods {
	...
	public GoogleIntegration_Pg3TeacherRegistration(RemoteWebDriver driver, ExtentTest node, Properties prop, String Environment, String StageURL, String Stage1URL) {
		this.driver = driver;
		this.node = node;
		this.prop = prop;
	...
	public GoogleIntegration_Pg3TeacherRegistration launchURL() {
	...
	public GoogleIntegration_Pg3TeacherRegistration Registrationpage1() {
	...
	public GoogleIntegration_Pg3TeacherRegistration verifypagecount3() throws IOException {
	...
	public GoogleIntegration_Pg3TeacherRegistration verifypage3fields() {
	...
	public GoogleIntegration_Pg3TeacherRegistration verifyclickbackbutton() {
		waitTime(3000);
	...
	public GoogleIntegration_Pg3TeacherRegistration verifyunchecktermsofusecheckbox() {
		WebElement Checkbox2 = propElement(getPropfile(gpropname5, "Checkbox2"));
	...
	public GoogleIntegration_Pg3TeacherRegistration verifygettingstartedpagewithemailcheck() {
		WebElement Checkbox1 = propElement(getPropfile(gpropname5, "Checkbox1"));
		if (Checkbox1.isSelected()) {
	...
	public GoogleIntegration_Pg3TeacherRegistration verifydeleteuserfrombackend() {
	...
	public GoogleIntegration_Pg3TeacherRegistration verifygettingstartedpagewithemailuncheck() {
		WebElement Checkbox1 = propElement(getPropfile(gpropname5, "Checkbox1"));
		Checkbox1.click();
		waitTime(3000);
		if (!Checkbox1.isSelected()) {
	...
	public GoogleIntegration_Pg3TeacherRegistration verifywithchecksyncclasses1() {
		WebElement Checkbox1 = propElement(getPropfile(gpropname5, "Checkbox1"));
		if (Checkbox1.isSelected()) {
			reportStep(Checkbox1.getText() + "is checked", "Pass");
		} else {
	...
	public GoogleIntegration_Pg3TeacherRegistration verifywithchecksyncclasses2() {
		WebElement Checkbox1 = propElement(getPropfile(gpropname5, "Checkbox1"));
		if (Checkbox1.isSelected()) {
			Checkbox1.click();
