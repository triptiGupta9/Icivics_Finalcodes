...
public class HomePage_5HeaderSigninMisc extends ProjectSpecificMethods {
	...
	public HomePage_5HeaderSigninMisc(RemoteWebDriver driver, ExtentTest node, Properties prop, String Environment, String StageURL, String Stage1URL) {
		this.driver = driver;
		this.node = node;
		this.prop = prop;
	...
	public HomePage_5HeaderSigninMisc launchURL() {
	...
	public HomePage_5HeaderSigninMisc VerifyDonatebutton() {
	...
	public HomePage_5HeaderSigninMisc VerifyDonateclick() throws IOException {
		waitTime(3000);
	...
	public HomePage_5HeaderSigninMisc VerifyShopbutton() {
	...
	public HomePage_5HeaderSigninMisc VerifyShopbuttonclick() throws IOException {
	...
	public HomePage_5HeaderSigninMisc verifysigninbutton() {
	...
	public HomePage_5HeaderSigninMisc verifysigninbuttonsubmenulist() {
	...
	public HomePage_5HeaderSigninMisc Signinbuttonelementsverification() throws IOException {
	...
	public HomePage_5HeaderSigninMisc verifyselectedsigninunderlined() {
	...
	public HomePage_5HeaderSigninMisc verifyselectedregasmystuunderlined() {
		waitTime(3000);
	...
	public HomePage_5HeaderSigninMisc verifyselectedregzasmyteacherunderlined() {
		waitTime(3000);
	...
	public HomePage_5HeaderSigninMisc Clickonsigninbuttonagain() {
