...
public class HomePage_3HeaderTeach extends ProjectSpecificMethods {
	...
	public HomePage_3HeaderTeach(RemoteWebDriver driver, ExtentTest node, Properties prop, String Environment, String StageURL, String Stage1URL) {
		this.driver = driver;
		this.node = node;
		this.prop = prop;
	...
	public HomePage_3HeaderTeach launchURL() {
	...
	public HomePage_3HeaderTeach verifyteachmenu() {
	...
	public HomePage_3HeaderTeach verifyteachmenulist() {
	...
	public HomePage_3HeaderTeach Teachbuttonelementsverification() throws IOException {
	...
	public HomePage_3HeaderTeach clickteachbuttonagain() {
		WebElement teachbutton = propElement(getPropfile(gpropname1, "Teachbutton"));
		if (teachbutton.isDisplayed()) {
