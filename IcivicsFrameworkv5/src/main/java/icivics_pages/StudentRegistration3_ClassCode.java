...
public class StudentRegistration3_ClassCode extends ProjectSpecificMethods {
	...
	public StudentRegistration3_ClassCode(RemoteWebDriver driver, ExtentTest node, Properties prop, String Environment, String StageURL, String Stage1URL) {
		this.driver = driver;
		this.node = node;
		this.prop = prop;
	...
	public StudentRegistration3_ClassCode launchstudentURL() {
	...
	public StudentRegistration3_ClassCode verifyregistrationwithvaliddata() throws InterruptedException, IOException {
	...
	public StudentRegistration3_ClassCode verifypagecount3() throws IOException {
	...
	public StudentRegistration3_ClassCode verifyusernamegenerateddisplay() throws IOException {
	...
	public StudentRegistration3_ClassCode verifyusernametextddisplay() {
	...
	public StudentRegistration3_ClassCode verifyemailddisplay() throws IOException {
	...
	public StudentRegistration3_ClassCode verifyemailtextddisplay() {
	...
	public StudentRegistration3_ClassCode clickcontinuetomyassignmentbutton() {
