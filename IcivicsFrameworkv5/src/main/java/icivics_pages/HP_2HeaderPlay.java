...
public class HP_2HeaderPlay extends ProjectSpecificMethods {
	...
	public HP_2HeaderPlay verifyplaysubmenu() {
	...
	public HP_2HeaderPlay verifyplaysubmenulist() {
	...
	public HP_2HeaderPlay Playbuttonelementsverification() throws IOException {
	...
	public HP_2HeaderPlay clickplaybuttonagain() {
