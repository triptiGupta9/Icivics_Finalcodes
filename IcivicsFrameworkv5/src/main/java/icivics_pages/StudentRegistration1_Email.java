...
public class StudentRegistration1_Email extends ProjectSpecificMethods {
	public String gpropname = "StudentRegistration/studentregistration1Email";

	public StudentRegistration1_Email(RemoteWebDriver driver, ExtentTest node, Properties prop, String Environment, String StageURL, String Stage1URL) {
		this.driver = driver;
		this.node = node;
		this.prop = prop;
	...
	public StudentRegistration1_Email launchstudentURL() {
	...
	public StudentRegistration1_Email verifystudentpage() {
		if (Environment.equals("Stage.d9")) {
	...
	public StudentRegistration1_Email verifybreadcrumbs() throws IOException {
	...
	public StudentRegistration1_Email verifypagecount1() throws IOException {
	...
	public StudentRegistration1_Email verifyregistrationvideolink() throws IOException {
	...
	public StudentRegistration1_Email Verifyusernametextfields() throws IOException {
	...
	public StudentRegistration1_Email Verifyfirstnamenametextfields() throws IOException {
	...
	public StudentRegistration1_Email Verifylastnametextfields() throws IOException {
	...
	public StudentRegistration1_Email Verifyemailtextfields() throws IOException {
	...
	public StudentRegistration1_Email Verifyemail2textfields() throws IOException {
	...
	public StudentRegistration1_Email usernamepregenerated() throws InterruptedException, IOException {
		WebElement username = propElement(getPropfile(gpropname, "username"));
		waitTime(6000);
	...
	public StudentRegistration1_Email usernamegeneratedrandomly() throws InterruptedException, IOException {
		WebElement username = propElement(getPropfile(gpropname, "username"));
		waitTime(6000);
		String username1 = username.getText();
	...
	public StudentRegistration1_Email entertextinusernamefield() throws InterruptedException, IOException {
		WebElement username = propElement(getPropfile(gpropname, "username"));
		try {
	...
	public StudentRegistration1_Email entertextinfirstnamefield() throws InterruptedException, IOException {
		WebElement firstname = propElement(getPropfile(gpropname, "firstname"));
	...
	public StudentRegistration1_Email entertextinlastnamefield() throws InterruptedException, IOException {
		WebElement lastname = propElement(getPropfile(gpropname, "Lastname"));
	...
	public StudentRegistration1_Email entertextinemailfield() throws InterruptedException, IOException {
	...
	public StudentRegistration1_Email entertextinverifyemailfield() throws InterruptedException, IOException {
	...
	public StudentRegistration1_Email usernameAsteriks() throws IOException {
		WebElement usernamelabel = propElement(getPropfile(gpropname, "usernamelabel"));
	...
	public StudentRegistration1_Email firstnameAsteriks() throws IOException {
	...
	public StudentRegistration1_Email lastnameAsteriks() throws IOException {
	...
	public StudentRegistration1_Email emailAsteriks() throws IOException {
		scrollToTheGivenWebElement(getPropfile(gpropname, "Emailaddresslabel"));
	...
	public StudentRegistration1_Email verifyemailAsteriks() throws IOException {
	...
	public StudentRegistration1_Email hoveronemailfield() throws InterruptedException, IOException {
	...
	public StudentRegistration1_Email hoveronverifyemailfield() throws InterruptedException, IOException {
	...
	public StudentRegistration1_Email Enterinvalidfirstname() throws InterruptedException, IOException {
		WebElement firstname = propElement(getPropfile(gpropname, "firstname"));
		if (firstname.isDisplayed()) {
			firstname.clear();
	...
	public StudentRegistration1_Email Enterinvalidlastname() throws InterruptedException, IOException {
		WebElement lastname = propElement(getPropfile(gpropname, "Lastname"));
		if (lastname.isDisplayed()) {
			lastname.clear();
	...
	public StudentRegistration1_Email Enterinvalidemailfield() throws InterruptedException {
		WebElement email = propElement(getPropfile(gpropname, "Emailaddress"));
		if (email.isDisplayed()) {
			email.clear();
	...
	public StudentRegistration1_Email Enterinvalidverifyemailfield() throws InterruptedException {
		WebElement verifyemail = propElement(getPropfile(gpropname, "VerifyEmailaddress"));
		if (verifyemail.isDisplayed()) {
			verifyemail.clear();
			waitTime(3000);
	...
	public StudentRegistration1_Email clicknextbutton() {
		scrollToTheGivenWebElement(getPropfile(gpropname, "Emailaddresslabel"));
	...
	public StudentRegistration1_Email verifyerrormsgforinvaliddatasubmit() {
	...
	public StudentRegistration1_Email verifyerrormsgblankfieldall() throws InterruptedException {
	...
	public StudentRegistration1_Email verifyerrormsgfirstnameblankfield() throws InterruptedException {
	...
	public StudentRegistration1_Email verifyerrormsglastnameblankfield() throws InterruptedException {
	...
	public StudentRegistration1_Email verifyerrormsgemailblankfield() throws InterruptedException {
	...
	public StudentRegistration1_Email verifyerrormsgverifyemailblankfield() throws InterruptedException {
	...
	public StudentRegistration1_Email verifyregistrationwithvaliddata() throws InterruptedException, IOException {
	...
	public StudentRegistration1_Email verifyclasscodelink() throws IOException {
