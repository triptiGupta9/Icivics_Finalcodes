...
public class StudentRegistration2_ClassCode extends ProjectSpecificMethods {
	...
	public StudentRegistration2_ClassCode(RemoteWebDriver driver, ExtentTest node, Properties prop, String Environment, String StageURL, String Stage1URL) {
		this.driver = driver;
		this.node = node;
		this.prop = prop;
	...
	public StudentRegistration2_ClassCode launchstudentURL() {
	...
	public StudentRegistration2_ClassCode verifyregistrationwithvaliddata() throws InterruptedException, IOException {
	...
	public StudentRegistration2_ClassCode verifypagecount2() throws IOException {
	...
	public StudentRegistration2_ClassCode Clickbackbutton() throws InterruptedException, IOException {
	...
	public StudentRegistration2_ClassCode verifyClickbackbutton() throws InterruptedException, IOException {
		WebElement backbutton = propElement(getPropfile(gpropname3, "backbutton"));
		backbutton.click();
		waitTime(3000);
		String cssvalue = "background-color";
	...
	public StudentRegistration2_ClassCode verifyclasscoderemembered() throws IOException {
	...
	public StudentRegistration2_ClassCode verifyusernameisnotremembered() throws IOException {
	...
	public StudentRegistration2_ClassCode verifyfirstnameremembered() throws IOException {
	...
	public StudentRegistration2_ClassCode verifylastnameremembered() {
	...
	public StudentRegistration2_ClassCode verifyemailremembered() {
	...
	public StudentRegistration2_ClassCode verifyemailfieldremembered() {
		scrollToTheGivenWebElement(getPropfile(gpropname1, "Emailaddresslabel"));
	...
	public StudentRegistration2_ClassCode clickontermsofuselink() throws IOException {
		waitTime(5000);
	...
	public StudentRegistration2_ClassCode clickprivacypolicy() {
	...
	public StudentRegistration2_ClassCode verifypage2noemailsubscriptioncheckbox() {
	...
	public StudentRegistration2_ClassCode hoveronpwdfield() throws InterruptedException {
	...
	public StudentRegistration2_ClassCode VerifyPasswordstrengthmeter() {
	...
	public StudentRegistration2_ClassCode VerifyPasswordindicatormatch() {
	...
	public StudentRegistration2_ClassCode verifyblankerrormsgforpwdandcpwd() {
		scrollToTheGivenWebElement(getPropfile(gpropname3, "finishbutton"));
	...
	public StudentRegistration2_ClassCode verifyenterinvaliddataerror() {
	...
	public StudentRegistration2_ClassCode verifytermsofuseandprivacycheckbox() {
	...
	public StudentRegistration2_ClassCode verifyblankerrormsg() {
		scrollToTheGivenWebElement(getPropfile(gpropname3, "finishbutton"));
		String pwd = "gfgh^d$fthf&";
		WebElement password = propElement(getPropfile(gpropname3, "password1"));
	...
	public StudentRegistration2_ClassCode verifypage3loaded() throws InterruptedException, IOException {
