...
import icivics_pages.StudentRegistration1Email;
import projectSpecific.base.ProjectSpecificMethods;

public class I21_StudentRegistration1Email_Test extends ProjectSpecificMethods {
	...
	public void C383_Verifybreadcrumbs() throws IOException, InterruptedException {
		...
		new StudentRegistration1Email(driver, node, prop, Environment, StageURL, Stage1URL).launchstudentURL().verifystudentpage().verifybreadcrumbs();
	}
	...
	public void C384_Verifybreadcrumbspage() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new StudentRegistration1Email(driver, node, prop, Environment, StageURL, Stage1URL).launchstudentURL().verifypagecount1();
	}
	...
	public void C385_Verifyvideolink() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new StudentRegistration1Email(driver, node, prop, Environment, StageURL, Stage1URL).launchstudentURL().verifyregistrationvideolink();
	}
	...
	public void C387_verifytextfields() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new StudentRegistration1Email(driver, node, prop, Environment, StageURL, Stage1URL).launchstudentURL().Verifyusernametextfields()
	...
	public void C388_verifyusernamepregenerated() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new StudentRegistration1Email(driver, node, prop, Environment, StageURL, Stage1URL).launchstudentURL().usernamepregenerated();
	}
	...
	public void C389_verifyusernamepregeneratedrandomly() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new StudentRegistration1Email(driver, node, prop, Environment, StageURL, Stage1URL).launchstudentURL().usernamegeneratedrandomly();
	}
	...
	public void C390_verifyentertextinallfields() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new StudentRegistration1Email(driver, node, prop, Environment, StageURL, Stage1URL).launchstudentURL().entertextinusernamefield()
	...
	public void C391_verifyfieldsmarkedwithanasterisk() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new StudentRegistration1Email(driver, node, prop, Environment, StageURL, Stage1URL).launchstudentURL().usernameAsteriks().firstnameAsteriks()
	...
	public void C392_verifyemailtooltips() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new StudentRegistration1Email(driver, node, prop, Environment, StageURL, Stage1URL).launchstudentURL().hoveronemailfield().hoveronverifyemailfield();
	}
	...
	public void C393_verifyemailerrormsg() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new StudentRegistration1Email(driver, node, prop, Environment, StageURL, Stage1URL).launchstudentURL().Enterinvalidfirstname().Enterinvalidlastname()
	...
	public void C394_verifyblankerrormsg() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new StudentRegistration1Email(driver, node, prop, Environment, StageURL, Stage1URL).launchstudentURL().verifyerrormsgblankfieldall()
	...
	public void C396_verifyvalidregistration() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new StudentRegistration1Email(driver, node, prop, Environment, StageURL, Stage1URL).launchstudentURL().verifyregistrationwithvaliddata();
	}
	...
	// C397 - Does classcode link lead to class code page
		...
		public void C397_Verifyclasscodelink() throws IOException, InterruptedException {
			...
			extent.attachReporter(spark);
			new StudentRegistration1Email(driver, node, prop, Environment, StageURL, Stage1URL).launchstudentURL().verifyclasscodelink();
		}
}
