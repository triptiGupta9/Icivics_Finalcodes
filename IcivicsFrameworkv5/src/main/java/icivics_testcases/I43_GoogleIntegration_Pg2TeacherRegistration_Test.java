...
import icivics_pages.GoogleIntegration_Pg2TeacherRegistration;
import projectSpecific.base.ProjectSpecificMethods;

public class I43_GoogleIntegration_Pg2TeacherRegistration_Test extends ProjectSpecificMethods {
	...
	public void C545_VerifyTeacherregistrationpage1() throws IOException, InterruptedException {
		...
		new GoogleIntegration_Pg2TeacherRegistration(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().Registrationpage()
				.verifypagecount2();
	}
