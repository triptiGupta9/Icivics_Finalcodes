...
import icivics_pages.HomePage_3Headerteach2;
import projectSpecific.base.ProjectSpecificMethods;

public class I34_HomePage_3Headerteach2_Test extends ProjectSpecificMethods {
	...
	public void C19_Verifyteachsubmenu() throws IOException, InterruptedException {
		...
		new HomePage_3Headerteach2(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().verifyteachmenu().verifytextisunderlined()
