...
import icivics_pages.GoogleIntegration_SignOn;
import projectSpecific.base.ProjectSpecificMethods;

public class I40_GoogleIntegration_signon_Test extends ProjectSpecificMethods {
	...
	public void C539_Verifygooglesiginpage() throws IOException, InterruptedException {
		...
		new GoogleIntegration_SignOn(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().verifygoogleaccount();
	}
	...
	public void C540_verifyentercredentails() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new GoogleIntegration_SignOn(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().verifyentercredentails();
	}
	...
	public void C541_verifyentercredentails2() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new GoogleIntegration_SignOn(driver, node, prop, Environment, StageURL, Stage1URL).launchURL()
	...
	public void C542_verifyentercredentailsasstudent() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new GoogleIntegration_SignOn(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().verifyentercredentailsasStudent();
	}
