...
import icivics_pages.PlayHub_MainsGamePage;
import projectSpecific.base.ProjectSpecificMethods;

public class I51_PlayHub_MainsGamePage_Test extends ProjectSpecificMethods {

	@BeforeTest
	public void setValues() {
		testCaseName = "Maingamespage";
		authors = "Venkat";
		category = "Smoke";
	...
	public void C73_Verifymainsgamepage() throws IOException, InterruptedException {
		...
		new PlayHub_MainsGamePage(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().Verifygamecarousel();
	}
	...
	public void C73_Verifyleftcarousel() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new PlayHub_MainsGamePage(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().Verifyleftcarousel();
	}
	...
	public void C73_Verifyrightcarousel() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new PlayHub_MainsGamePage(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().Verifyrightcarousel();
	}
	...
	public void C73_Verifycarouseldots() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new PlayHub_MainsGamePage(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().Verifycarouseldots();
	}
	...
	public void C73_Verifycarouseldots3rdpage() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new PlayHub_MainsGamePage(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().Verifycarouseldots3rdgame();
	}
	
	// C73 - Register banner not logged in
	@Test(priority = 5)
	public void C73_Verifybannerasananonymoususer() throws IOException, InterruptedException {
		node = test.createNode("C73 - Register banner not logged in as ananonymous user");
		extent.attachReporter(spark);
		new PlayHub_MainsGamePage(driver, node, prop, Environment, StageURL, Stage1URL).launchURL()
	...
	public void C73_Verifybannerasastudentlogin() throws IOException, InterruptedException {
		node = test.createNode("C73 - Register banner logged in as student");
		extent.attachReporter(spark);
		new PlayHub_MainsGamePage(driver, node, prop, Environment, StageURL, Stage1URL)
	...
	public void C73_Verifybannerasateacherlogin() throws IOException, InterruptedException {
		node = test.createNode("C73 - Register banner logged in as teacher");
		extent.attachReporter(spark);
		new PlayHub_MainsGamePage(driver, node, prop, Environment, StageURL, Stage1URL).
	...
	public void C73_VerifygamesTiles() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new PlayHub_MainsGamePage(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().Verifygamestitles();
	}
	...
	public void C73_VerifygamesTilesclick() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new PlayHub_MainsGamePage(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().Verifygamestitlesclick();
	}
	...
	public void C73_Verifyteachbutton() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new PlayHub_MainsGamePage(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().Verifyteachbuttonclick();
	}
	...
	public void C73_Verifygetstartedbutton() throws IOException, InterruptedException {
		node = test.createNode("C73 - Teacher tile");
		extent.attachReporter(spark);
		new PlayHub_MainsGamePage(driver, node, prop, Environment, StageURL, Stage1URL).launchURL(). Verifygetstartedbuttonclick() ;
	}
}
