...
public class I33_HP_3HeaderTeach_Test extends ProjectSpecificMethods {
	...
	public void C15_Verifyteachsubmenu() throws IOException, InterruptedException {
		...
		new HP_3HeaderTeach(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().verifyteachmenu();
	}
	...
	public void C16_Verifysubmenucount() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new HP_3HeaderTeach(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().verifyteachmenu().verifyteachmenulist();
	}
	...
	public void C17_Verifyteachbuttonelements() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new HP_3HeaderTeach(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().Teachbuttonelementsverification();
	}
	...
	public void C20_verifyclickteachbuttonagain() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new HP_3HeaderTeach(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().verifyteachmenu().clickteachbuttonagain();
	}
