...
import icivics_pages.StudentRegistration2Email;
import projectSpecific.base.ProjectSpecificMethods;

public class I23_StudentRegistration2Email_Test extends ProjectSpecificMethods {
	...
	public void C398_verifypagecount2() throws IOException, InterruptedException {
		...
		new StudentRegistration2Email(driver, node, prop, Environment, StageURL, Stage1URL).launchstudentURL().verifywithvaliddata().verifypagecount2();
	}
	...
	public void C399_Clickbackbutton() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new StudentRegistration2Email(driver, node, prop, Environment, StageURL, Stage1URL).launchstudentURL().verifywithvaliddata().verifyclickingbackbutton();
	}
	...
	public void C400_verifyfieldsisremembered() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new StudentRegistration2Email(driver, node, prop, Environment, StageURL, Stage1URL).launchstudentURL().verifywithvaliddata().clickbackbutton()
	...
	public void C403_clickontermsofuselink() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new StudentRegistration2Email(driver, node, prop, Environment, StageURL, Stage1URL).launchstudentURL().verifywithvaliddata()
	...
	public void C408_hoveronpwdfield() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new StudentRegistration2Email(driver, node, prop, Environment, StageURL, Stage1URL).launchstudentURL().verifywithvaliddata().hoveronpwdfield();
	}
