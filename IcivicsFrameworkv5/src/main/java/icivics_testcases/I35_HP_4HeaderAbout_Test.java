...
import icivics_pages.HP_4HeaderAbout;

import projectSpecific.base.ProjectSpecificMethods;

public class I35_HP_4HeaderAbout_Test extends ProjectSpecificMethods {
	...
	public void C22_Verifyaboutsubmenu() throws IOException, InterruptedException {
		...
		new HP_4HeaderAbout(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().clickonaboutmenu().verifyaboutbuttonathomepage();
	}
	...
	public void C23_Verifysubmenucount() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new HP_4HeaderAbout(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().clickonaboutmenu().verifyaboutoptionscount();
	}
	...
	public void C24_VerifysubmenuElement() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new HP_4HeaderAbout(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().aboutbuttonelementsverification();
	}
	...
	public void C27_Verifyclickaboutbuttonagain() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new HP_4HeaderAbout(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().clickonaboutmenu().clickaboutbuttonagain();
	}
}
