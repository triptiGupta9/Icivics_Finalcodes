...
import icivics_pages.StudentRegistration1_ClassCode;
import projectSpecific.base.ProjectSpecificMethods;

public class I20_StudentRegistration1_ClassCode_Test extends ProjectSpecificMethods {
	...
	public void C425_verifyemailfieldsappear() throws IOException, InterruptedException {
		...
		new StudentRegistration1_ClassCode(driver, node, prop, Environment, StageURL, Stage1URL).launchstudentURL().verifyOptionallink();
	}
	...
	public void C426_verifyemailtooltips() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new StudentRegistration1_ClassCode(driver, node, prop, Environment, StageURL, Stage1URL).launchstudentURL().hoveronemailfield()
	...
	public void C427_verifyemailfieldsdisappear() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new StudentRegistration1_ClassCode(driver, node, prop, Environment, StageURL, Stage1URL).launchstudentURL().clickonremovelink();
	}
	...
	public void C428_verifyusernamepregenerated() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new StudentRegistration1_ClassCode(driver, node, prop, Environment, StageURL, Stage1URL).launchstudentURL().usernamepregenerated();
	}
	...
	public void C429_usernamegeneratedrandomly() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new StudentRegistration1_ClassCode(driver, node, prop, Environment, StageURL, Stage1URL).launchstudentURL().usernamegeneratedrandomly();
	}
	...
	public void C430_verifyregistrationwithvaliddata() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new StudentRegistration1_ClassCode(driver, node, prop, Environment, StageURL, Stage1URL).launchstudentURL().clickOptionallink()
	...
	public void C432_verifyinvaliderrormsg() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new StudentRegistration1_ClassCode(driver, node, prop, Environment, StageURL, Stage1URL).launchstudentURL().verifyinvaliderrormsg();
	}
	...
	public void C433_verifyerrormsgverifyemailblankfield() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new StudentRegistration1_ClassCode(driver, node, prop, Environment, StageURL, Stage1URL).launchstudentURL().verifyerrormsgblankfieldall()
	...
	public void C434_verifyinvaliderrormsg2() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new StudentRegistration1_ClassCode(driver, node, prop, Environment, StageURL, Stage1URL).launchstudentURL().verifyinvaliderrormsg2();
	}
	...
	public void C435_verifyregistrationwithvalidvalue() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new StudentRegistration1_ClassCode(driver, node, prop, Environment, StageURL, Stage1URL).launchstudentURL().verifyregistrationwithvalidvalue();
	}
}
