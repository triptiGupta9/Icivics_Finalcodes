...
import icivics_pages.HomePage_1Header;
import projectSpecific.base.ProjectSpecificMethods;

public class I30_HomePage_1Header_Test extends ProjectSpecificMethods {
	...
	public void C1_VerifyLogo() throws IOException, InterruptedException {
		...
		new HomePage_1Header(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().VerifyLogo();
	}
	...
	public void C2_VerifyHeaderbuttonforanonymoususer() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new HomePage_1Header(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().VerifyDonatebutton()
	...
	public void C2_VerifyHeaderbuttonforauthenticateduser() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new HomePage_1Header(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().signin().Verifyheaderbuttonsafterlogin();
	}
	...
	public void C1538_Verifydonationpopup() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new HomePage_1Header(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().Verifydonationpopup();
	}
