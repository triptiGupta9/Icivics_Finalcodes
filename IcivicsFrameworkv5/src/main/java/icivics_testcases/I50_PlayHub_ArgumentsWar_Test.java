...
import icivics_pages.PlayHub_AgrumentsWar;

import projectSpecific.base.ProjectSpecificMethods;

public class I50_PlayHub_ArgumentsWar_Test extends ProjectSpecificMethods {
	...
	public void C81_Verifylink() throws IOException, InterruptedException {
		...
		new PlayHub_AgrumentsWar(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().verifylink();
	}
	...
	public void C82_Verifypopup() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new PlayHub_AgrumentsWar(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().verifylinkpopup();
	}
	...
	public void C84_Verifyeducatorbutton() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new PlayHub_AgrumentsWar(driver, node, prop, Environment, StageURL, Stage1URL).launchURL()
	...
	public void C87_Verifyassignpopup() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new PlayHub_AgrumentsWar(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().verifyassignpopup();
	}
	// C88 - Assign button
	...
	public void C88_Verifyassignform() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new PlayHub_AgrumentsWar(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().verifyassignform();
	}
	...
	public void C89_Verifyappleapp() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new PlayHub_AgrumentsWar(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().verifyappleapp();
	}
	...
	public void C90_Verifyappleapppage() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new PlayHub_AgrumentsWar(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().verifyappleapppage();
	}
	...
	public void C91_Verifygoogleplaybutton() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new PlayHub_AgrumentsWar(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().verifygoogleplaybutton();
	}
	...
	public void C92_Verifygoogleplaypage() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new PlayHub_AgrumentsWar(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().verifygoogleplaypage();
	}
	...
	public void C93_Verifyextensionpack() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new PlayHub_AgrumentsWar(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().verifyextensionpacklink();
	}
