...
import icivics_pages.HomePage_1TeacherHeader;
import projectSpecific.base.ProjectSpecificMethods;

public class I31_HomePage_1TeacherHeader_Test extends ProjectSpecificMethods {
	...
	public void C3_Verifyheaderbuttonsforanonymoususer() throws IOException, InterruptedException {
		...
		new HomePage_1TeacherHeader(driver, node, prop, Environment, StageURL, Stage1URL).launchteacherpageURL().playbutton().Teachbutton()
	...
	public void C3_Verifyheaderbuttonsforauthenticateduser() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new HomePage_1TeacherHeader(driver, node, prop, Environment, StageURL, Stage1URL).launchteacherpageURL().signin2()
	...
	public void C4_Verifyheaderelemets() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new HomePage_1TeacherHeader(driver, node, prop, Environment, StageURL, Stage1URL).launchteacherpageURL().verifyblogcontenttype()
	...
	public void C6_Verifyheaderbuttonhoverforanonymoususer() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new HomePage_1TeacherHeader(driver, node, prop, Environment, StageURL, Stage1URL).launchteacherpageURL().verifyplaybuttonhover()
	...
	public void C7_verifyresizeheaderintohamburger() throws IOException, InterruptedException {
		...
		new HomePage_1TeacherHeader(driver, node, prop, Environment, StageURL, Stage1URL).launchteacherpageURL().resizeheader()
