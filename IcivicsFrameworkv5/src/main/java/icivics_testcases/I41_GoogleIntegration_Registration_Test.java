...
import icivics_pages.GoogleIntegration_Registration;

import projectSpecific.base.ProjectSpecificMethods;

public class I41_GoogleIntegration_Registration_Test extends ProjectSpecificMethods {
	...
	public void C544_Verifyeducatorregistrationpage1() throws IOException, InterruptedException {
		...
		new GoogleIntegration_Registration(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().verifyclickregisteraseducator();
	}
	...
	public void C545_Verifyregistrationwithoutsignin() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new GoogleIntegration_Registration(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().verifyregistrationwithoutsignin();
	}
	...
	public void C546_Verifyregistrationwithalreadyregisteredid() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new GoogleIntegration_Registration(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().verifyregistrationwithalreadyregisteredID();
	}
	// C544 - ""After Google sign-in with account not registered at iCivics
	...
	public void C544_Verifystudentregistrationpage1() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new GoogleIntegration_Registration(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().verifyregisterasstudentclick();
	}
}
