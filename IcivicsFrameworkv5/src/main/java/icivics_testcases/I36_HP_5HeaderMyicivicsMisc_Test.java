...
import icivics_pages.HP_5HeaderMyicivicsMisc;
import projectSpecific.base.ProjectSpecificMethods;

public class I36_HP_5HeaderMyicivicsMisc_Test extends ProjectSpecificMethods {
	...
	public void C29_Verifydonatebutton() throws IOException, InterruptedException {
		...
		new HP_5HeaderMyicivicsMisc(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().verifylogin().VerifyDonatebutton();
	}
	...
	public void C30_Verifydonatebuttonclick() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new HP_5HeaderMyicivicsMisc(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().verifylogin().VerifyDonateclick();
	}
	...
	public void C31_Verifyshopbutton() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new HP_5HeaderMyicivicsMisc(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().verifylogin().VerifyShopbutton();
	}
	...
	public void C32_Verifyshopbuttonclick() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new HP_5HeaderMyicivicsMisc(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().verifylogin().VerifyShopbuttonclick();
	}
	...
	public void C34_VerifyIcivicsbutton() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new HP_5HeaderMyicivicsMisc(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().verifylogin()
	...
	public void C35_Verifytheavatar() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new HP_5HeaderMyicivicsMisc(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().verifylogin().verifywithavatar();
	}
	...
	public void C35_Verifythenoavatar() throws IOException, InterruptedException {
		node = test.createNode("C35 - Can you see your avatar icon represented in the button?");
		extent.attachReporter(spark);
		new HP_5HeaderMyicivicsMisc(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().verifywithnoavatar();
	}
