...
import icivics_pages.GoogleIntegration_Pg1TeacherRegistration;
import projectSpecific.base.ProjectSpecificMethods;

public class I42_GoogleIntegration_Pg1TeacherRegistration_Test extends ProjectSpecificMethods {
	...
	public void C545_VerifyTeacherregistrationpage1() throws IOException, InterruptedException {
		...
		new GoogleIntegration_Pg1TeacherRegistration(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().verifydeleteuserfrombackend().launchURL()
	...
	public void C546_Verifyroleandgradefield() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new GoogleIntegration_Pg1TeacherRegistration(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().Registrationpage().verifygradelevelfield()
	...
	public void C547_Verifyroleandgradefield() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new GoogleIntegration_Pg1TeacherRegistration(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().Registrationpage().verifygradelevelselection()
	...
	public void C548_Verifyleavegradeboxesunchecked() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new GoogleIntegration_Pg1TeacherRegistration(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().Registrationpage()
	...
	public void C549_Verifyleaverolenoneselected() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new GoogleIntegration_Pg1TeacherRegistration(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().Registrationpage().verifyleaverolenoneselected();
	}
	...
	public void C550_Verifyenterwithvaliddata() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new GoogleIntegration_Pg1TeacherRegistration(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().Registrationpage().verifyentervaliddata();
	}
}
