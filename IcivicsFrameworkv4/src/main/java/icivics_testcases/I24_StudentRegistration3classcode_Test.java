...
import icivics_pages.StudentRegistration3classcode;
import projectSpecific.base.ProjectSpecificMethods;

public class I24_StudentRegistration3classcode_Test extends ProjectSpecificMethods {
	...
	public void C454_verifypagecount3() throws IOException, InterruptedException {
		...
		new StudentRegistration3classcode(driver, node, prop, Environment, StageURL, Stage1URL).launchstudentURL().verifyregistrationwithvaliddata()
				.verifypagecount3();
	}
