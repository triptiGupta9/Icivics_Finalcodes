...
import icivics_pages.StudentRegistration2classcode;
import projectSpecific.base.ProjectSpecificMethods;

public class I22_StudentRegistration2classcode_Test extends ProjectSpecificMethods {
	...
	public void C398_verifypagecount2() throws IOException, InterruptedException {
		...
		new StudentRegistration2classcode(driver, node, prop, Environment, StageURL, Stage1URL).launchstudentURL()
