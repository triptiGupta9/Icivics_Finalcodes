...
public class I45_Googlestudentregistration_Test extends ProjectSpecificMethods {
	...
	public void C557_Verifyagreetotermsandconditionfield() throws IOException, InterruptedException {
		...
		new Googlestudentregistration(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().
