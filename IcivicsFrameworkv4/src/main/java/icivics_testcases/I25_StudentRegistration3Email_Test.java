...
public class I25_StudentRegistration3Email_Test extends ProjectSpecificMethods {
	...
	public void C372_verifypagecount3() throws IOException, InterruptedException {
		...
		new StudentRegistration3Email(driver, node, prop, Environment, StageURL, Stage1URL).launchstudentURL().verifywithvaliddata().verifypagecount3();
	}
	...
	public void C373_verifycheckmsgdisplay() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new StudentRegistration3Email(driver, node, prop, Environment, StageURL, Stage1URL).launchstudentURL().verifywithvaliddata()
