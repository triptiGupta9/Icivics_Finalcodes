...
import icivics_pages.HP_5HeaderSigninMisc;
import projectSpecific.base.ProjectSpecificMethods;

public class I37_HP_5HeaderSigninMisc_Test extends ProjectSpecificMethods {
	...
	public void C29_Verifydonatebutton() throws IOException, InterruptedException {
		...
		new HP_5HeaderSigninMisc(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().VerifyDonatebutton();
	}
	...
	public void C30_Verifydonatebuttonclick() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new HP_5HeaderSigninMisc(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().VerifyDonateclick();
	}
	...
	public void C31_Verifyshopbutton() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new HP_5HeaderSigninMisc(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().VerifyShopbutton();
	}
	...
	public void C32_Verifyshopbuttonclick() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new HP_5HeaderSigninMisc(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().VerifyShopbuttonclick();
	}
	...
	public void C33_Verifysigninbuttonforanonymoususer() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new HP_5HeaderSigninMisc(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().verifysigninbutton();
	}
	...
	public void C37_Verifysigninbuttonsubmenu() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new HP_5HeaderSigninMisc(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().verifysigninbuttonsubmenulist();
	}
	...
	public void C38_Verifysigninbuttonsubmenu() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new HP_5HeaderSigninMisc(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().Signinbuttonelementsverification();
	}
	...
	public void C42_Verifysubmenuoptionisunderlined() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new HP_5HeaderSigninMisc(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().verifysigninbutton().Clickonsigninbuttonagain();
	}
