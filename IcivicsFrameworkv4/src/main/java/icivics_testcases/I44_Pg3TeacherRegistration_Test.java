...
public class I44_Pg3TeacherRegistration_Test extends ProjectSpecificMethods {
	...
	public void C551_Verifypagecount3() throws IOException, InterruptedException {
		...
		new Pg3TeacherRegistration(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().Registrationpage1().verifypagecount3();
	}
	...
	public void C552_Verifypage3fields() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new Pg3TeacherRegistration(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().Registrationpage1().verifypage3fields();
	}
	...
	public void C553_Verifybackbutton() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new Pg3TeacherRegistration(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().Registrationpage1().verifyclickbackbutton();
	}
	...
	public void C554_Verifygettingstartedpagewithemailcheck1() throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new Pg3TeacherRegistration(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().Registrationpage1()
	...
	public void C555_Verifygettingstartedpagewithemailuncheck() throws IOException, InterruptedException {
		node = test.createNode(
				"C555 - If you enter valid information, do not check sync classes, does it move you to the next page");
		extent.attachReporter(spark);
		new Pg3TeacherRegistration(driver, node, prop, Environment, StageURL, Stage1URL).launchURL().verifydeleteuserfrombackend().launchURL()
