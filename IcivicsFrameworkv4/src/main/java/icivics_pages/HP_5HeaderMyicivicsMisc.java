...
public class HP_5HeaderMyicivicsMisc extends ProjectSpecificMethods {
	...
	public HP_5HeaderMyicivicsMisc(RemoteWebDriver driver, ExtentTest node, Properties prop, String Environment, String StageURL, String Stage1URL) {
		this.driver = driver;
		this.node = node;
		this.prop = prop;
	...
	public HP_5HeaderMyicivicsMisc verifylogin() {
	...
	public HP_5HeaderMyicivicsMisc VerifyDonatebutton() {
	...
	public HP_5HeaderMyicivicsMisc VerifyDonateclick() throws IOException {
		waitTime(3000);
	...
	public HP_5HeaderMyicivicsMisc VerifyShopbutton() {
	...
	public HP_5HeaderMyicivicsMisc VerifyShopbuttonclick() throws IOException {
	...
	public HP_5HeaderMyicivicsMisc verifymyicvicsbuttonafterlogin() {
	...
	public HP_5HeaderMyicivicsMisc verifywithavatar() {
	...
	public HP_5HeaderMyicivicsMisc verifywithnoavatar() {
	...
	public HP_5HeaderMyicivicsMisc verifymyicvicsbuttonsubmenu() {
	...
	public HP_5HeaderMyicivicsMisc verifymyicivicssubmenulist() {
		WebElement myicivicsbutton = propElement(getPropfile(gpropname2, "Myicivicsbutton"));
		if (myicivicsbutton.isDisplayed()) {
			myicivicsbutton.click();
	...
	public HP_5HeaderMyicivicsMisc verifyselectedmyicivicsunderlined() {
	...
	public HP_5HeaderMyicivicsMisc verifyselectedmyclassesunderlined() {
	...
	public HP_5HeaderMyicivicsMisc verifyselectedmyfavoritesunderlined() {
	...
	public HP_5HeaderMyicivicsMisc Clickonmyicivicsbuttonagain() {
