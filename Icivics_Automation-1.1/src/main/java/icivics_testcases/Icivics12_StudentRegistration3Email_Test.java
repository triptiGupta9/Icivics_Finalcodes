...
public class Icivics12_StudentRegistration3Email_Test extends ProjectSpecificMethods {
	...
	public void C372_verifypagecount3(String URL) throws IOException, InterruptedException {
		...
		new Icivics_StudentReg3Email(driver, node, prop).launchstudentURL(URL).verifywithvaliddata().verifypagecount3();
	}
	...
	public void C373_verifycheckmsgdisplay(String URL) throws IOException, InterruptedException {
		...
		extent.attachReporter(reporter);
		new Icivics_StudentReg3Email(driver, node, prop).launchstudentURL(URL).verifywithvaliddata()
